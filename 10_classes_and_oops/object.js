...
console.log(circleArea.power);
console.log(circleArea.prototype);
...
createUser.prototype.printMe = function () {
    console.log(`price is ${this.score}`); // jis ka mtlb this (jisne bhi score pucha hai uska score btado)
}
...
Thios means that it has access to properties and methods defined on the constructor's prototype.
